...
import sys
sys.path.append("..")
from implementation import kaprekarNumbers

###not completed
class test_kaprekarNumbers(unittest.TestCase):
...
# First calculate that n^2 = 25. Split that into two strings and convert them back to 
# integers 2 and 5. Test 2 + 5 = 7 != 5, so this is not a modified Kaprekar number. If 
# n = 9, still d = 1, and n^2 = 81. This gives us 1 + 8 = 9, the original n.
...
# to the original number again. For instance, 45 is a Kaprekar number, because 45² = 2025 
# and 20+25 = 45.

# Given two positive integers p and q where p is lower than q, write a program to print the
# modified Kaprekar numbers in the range between p  and q, inclusive. If no modified
