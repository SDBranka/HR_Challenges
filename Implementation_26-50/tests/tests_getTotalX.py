...
class test_getTotalX(unittest.TestCase):
    def testSampleCaseZero(self):
        a = [2, 4]
        b = [16, 32, 96]
        self.assertEqual(getTotalX(a, b), 3)

    def testSampleCaseOne(self):
        a = [3, 4]
        b = [24, 48]
        self.assertEqual(getTotalX(a, b), 2)

    def testCaseZero(self):
        a = [2, 4] 
        b = [16, 32, 96]
        self.assertEqual(getTotalX(a, b), 3)
...
# Complete the getTotalX function in the editor below. It 
# should return the number of integers that are betwen the sets.
...
# The third line contains m distinct space-separated integers where 0<= j < m.
...
# element of a is a factor and each is a factor of all elements of b. 
